defmodule MediaStatsWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule MediaStatsWeb.MyChannel do
        use MediaStatsWebWeb, :channel
        alias MediaStatsWebWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :media_stats_web,
                        pubsub_server: MediaStatsWeb.PubSub
end
